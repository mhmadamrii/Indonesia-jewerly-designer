  ...
  (
    ...
    return (
      <Command
        ...
        className={cn("bg-card h-auto overflow-visible", commandProps?.className)}
        shouldFilter={
      ...
      >
        <div
          className={cn(
            "border-input focus-within:ring-ring flex items-start justify-between rounded-md border px-3 py-2 text-base md:text-sm",
            {
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "placeholder:text-muted-foreground bg-accent flex-1 self-baseline outline-none",
                {
